...
public class SignTransactionTest {
    ...
    public void testSerializeRawTransaction() {
        ...
        String pubKey = "5b9adf91a5d20f4d45cabe72f21077335152b3f1acf6f7ffee9e1ed975550ed7f75e6e31880a3418d06b6c578415a3b57c0d925ca2151f5313e5afc88c324a35";
        String key = pubKey.substring(0,64);
        int index = 0;
        signImpl.buildWitness(tx, index, priKey, key);
        //序列化
